...
import { ShieldAIDemoClient } from "./demo-client";
import {
  Camera,
  Layers3,
  FileText,
...
export default function ShieldAIPublicPage() {
  return (
    <>
      <Navbar />
      <main>
          ...
          <div className="mx-auto max-w-3xl px-6 lg:px-10">
            <div className="surface-card p-8">
              ...
              <p className="text-[14px] text-[var(--color-silver-100)] leading-relaxed mb-3">
                SHIELD AI is a preliminary analysis tool. It catches what is
              ...
              <p className="text-[14px] text-[var(--color-silver-100)] leading-relaxed">
                Treat SHIELD AI output as the starting list. The full SHIELD
        ...
        <section className="py-20">
          <div className="mx-auto max-w-3xl px-6 lg:px-10 text-center">
            ...
            <p className="text-[var(--color-silver-200)] mb-10">
              Free account includes your first SHIELD AI analysis. No credit
