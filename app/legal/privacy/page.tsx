    ...
    <article>
      ...
      <div className="space-y-6 text-[15px] text-[var(--color-silver-100)] leading-[1.8]">
        <Section title="What we collect">
          ...
          PRAESIDIUM analysis. When you contact us, we collect the information
        ...
        <Section title="Photos and PRAESIDIUM">
          Photos uploaded to PRAESIDIUM are processed by Anthropic&apos;s Claude
